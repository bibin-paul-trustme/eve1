...
// constructor
func newIPCServer(ctx *monitorContext) *monitorIPCServer {
...
func (r *request) handleRequest(ctx *monitorContext) *response {
...
func (ctx *monitorContext) startIPCServer() error {
