...
// h must be a collision-resistant one-way hash function (here using we are using SHA-256)
...
// hsk must be a secure MAC function h (here we using HMAC with SHA-256 and a secret key)
